...
https://static-assets.codecademy.com/Courses/intermediate-java/collections/ART-1625-collectionHierarchy-for-implementation.svg
The diagram above shows the hierarchy of the collections framework interfaces. The Collection interface is at the top of the hierarchy and is the root interface for all collections. The Collection interface extends the Iterable interface, which allows us to iterate over the elements in a collection.
*/