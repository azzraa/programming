  ...
  public class Books {
    public static void main(String[] args) {
      Lib fiction = new Lib("book", "fiction");
        ...
        System.out.println("Fiction Book Description = Literature that is imaginary.");
        book1.getDescription();
      
       Lib nonFiction = new Lib("book", "nonfiction");
        Lib.Book book2 = nonFiction.new Book();
        book2.setDescription();
        System.out.println("Non-fiction Book Description = Factual stories/accounts based on true events.");
